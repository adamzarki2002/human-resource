...
<img src="dist/img/${messageMetier.getEmployeMessage(msg).getPhotoEmploye() }" onerror="if (this.src != 'dist/img/person.jpg') this.src = 'dist/img/person.jpg';" class="img-circle elevation-2" alt="User Image">
        ...
        <div class="row">
          <!-- left column -->
            ...
            <div class="card card-primary" style="margin-left:255px">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form method="post" id="demo-form2"action="<%=request.getContextPath()%>/ajouterRetard"; data-parsley-validate>
              <div class="card-body">
              
              <div class="form-group">
                    <label for="exampleInputEmail1">id<span class="required">*</span></label>
                    <input type="text" class="form-control" id="exampleInputEmail1" name="id_Re" placeholder="Enter id" required="required">
                  </div>
          ...
          <div class="w-100">
              <div class="form-group">
                ...
                <div class="input-group date" id="id_0">
                  <input type="text" value="" name="dateR" class="form-control" placeholder="MM/DD/YYYY hh:mm:ss" required/>
                </div>
              </div>
          </div>
        </div>
  ...
  <script src="js/main.js"></script>
                ...
                <div class="form-group">
                  ...
                  <select name="natureR" id="natureR"  class="form-control select1" style="width: 100%;" required>
                ...
                <div class="card-footer">
                  <button type="submit" class="btn btn-primary">Ajouter Retard</button>
