      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-7" style="margin-left:220px">
            ...
            <form method="post" id="demo-form2" action="<%=request.getContextPath()%>/modifierEmploye" >
              <div class="card-body box-profile">
               <!-- <div class="text-center">
                <a href="editphoto?id1=${id.id}">
            ...
            onerror="if (this.src != 'dist/img/person.jpg') this.src = 'dist/img/person.jpg';"
                ...
                <h3 class="profile-username text-center"><input type="text" size="10" class="form-control" style="text-align:center;" value="${em.nom}" name="nom"></h3><h3 class="profile-username text-center"><input type="text" size="10" class="form-control" style="text-align:center;" value="${em.prenom}" name="prenom"></h3>
               ...
               <div class="form-group">
                            <input type="hidden" class="form-input" name="id" id="name" value="${em.getId()}"/></div>
                  <li class="list-group-item">
                    <b>Email</b> <a class="float-right"><input type="text" size="20"  value="${ em.getEmail()}" class="form-control" name="email"></a>
                  </li>
                    
                  <li class="list-group-item">
                    <b>Mot de passe</b> <a class="float-right"><input type="text" size="20"  value="${ em.getMdp()}" class="form-control" name="mdp"></a>
                  </li>
                  <li class="list-group-item">
                    <b>salaire</b> <a class="float-right"><input type="text" size="20"  value="${ em.getSalaire()}" class="form-control" name="salaire"></a>
                  </li>
                  <li class="list-group-item">
                    <b>numero de telephone</b> <a class="float-right"><input type="text" size="20"  value="${ em.numtel}" class="form-control" name="numtel"></a>
                  </li>
                  <li class="list-group-item">
                    <b>adresse</b> <a class="float-right"><input type="text" size="20"  value="${ em.adresse}" class="form-control" name="adresse"></a>
                  </li>
                  <li class="list-group-item">
                    <b>Poste</b> <select name="nomP_P" id="nomP_P"  class="form-control select1" style="width: 100%;" required>
                  
                    <option value="${ eme.nom_P}" >${ eme.nom_P}</option>
                            <option>AC</option>
                            <option>AE</option>
                            <option>ARE</option>
                            <option>EP/SE</option>
