                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">nombre d'absence</th>
                  ...
                  <c:forEach var="eme" items="${employe}">
                      ...
                      <td class="align-middle text-center text-sm">
                        <p class="text-xs font-weight-bold mb-0">${eme.id_Ab}</p>
                      </td>
                      
                      
                    
                      <td class="align-middle text-center">
                        <p class="text-xs font-weight-bold mb-0">${eme.nbreA}</p>
                      </td>
                      <td class="align-middle">
                        <a href="voir?id_Ab=${eme.id_Ab}" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                          voir
                        </a>
