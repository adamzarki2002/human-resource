...
<img src="dist/img/${messageMetier.getEmployeMessage(msg).getPhotoEmploye() }" onerror="if (this.src != 'dist/img/person.jpg') this.src = 'dist/img/person.jpg';" class="img-circle elevation-2" alt="User Image">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Modifier Retard</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="HomeAdmin">Home</a></li>
              <li class="breadcrumb-item active">Modifier Retard</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
      ...
      <div class="container-fluid">
        <div class="row">
          <!-- left column -->
            ...
            <div class="card card-primary" style="margin-left:255px; width: 400px;">
              <div class="card-header">
                <h3 class="card-title">Veuillez remplir les informations</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form method="post" id="demo-form2"action="<%=request.getContextPath()%>/modifierRetard"; data-parsley-validate>
              <div class="card-body">
              
              <div class="form-group">
                    <label for="exampleInputEmail1">id<span class="required">*</span></label>
                    <input type="text" class="form-control" id="exampleInputEmail1" name="id_Re" value="${ idR.id_Re}" placeholder="Enter id" required="required">
                  </div>
              
                
                     <section class="ftco-section" style="padding-top: 10px; padding-bottom: 10px;">
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-md-4 text-center">
          <h3 class="h5">DateTime</h3>
          <div class="w-100">
              <div class="form-group">
                <!-- <label class="label-control" for="id_start_datetime">Datetime picker</label> -->
                <div class="input-group date" id="id_0">
                  <input type="text" value="${ idR.dateR}" name="dateR" class="form-control"  required/>
                </div>
              </div>
          </div>
        </div>
  ...
  <script src="js/main.js"></script>
                ...
                <div class="form-group">
                  ...
                  <select name="natureR" id="natureR" value="${ idR.natureR}" class="form-control select1" style="width: 100%;" required>
                  
                    <option  selected disabled>${idR.natureR}</option>
               ...
               <div class="item form-group">
                        <div class="col-md-8 col-sm-8 offset-md-4">
                          <a href="listeRetard"><button class="btn btn-primary" type="button">Annuler</button></a>
