                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">id de l'absence</th>
                  ...
                  <c:forEach var="eme" items="${employe}">
                      ...
                      <td class="align-middle text-center text-sm">
                        <p class="text-xs font-weight-bold mb-0">${eme.idA}</p>
                      </td>
                     ...
                     <td class="align-middle">
                        <a href="edit1?idA=${eme.idA}" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                          Edit
                        </a>
                      </td>
                      <td class="align-middle">
                        <a href="supprimerAbsence?idA=${eme.idA}" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="supprimer user">
                          delete
                        </a>
                      </td>
