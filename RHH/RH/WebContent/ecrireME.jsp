...
<html lang="en">
    ...
    if(session.getAttribute("Email")==null){ response.sendRedirect("login.jsp");} %>
        ...
        <div id="layoutSidenav">
            ...
            <section class="content" style=" padding-left: 250px; width: 1750px;height: 500px">
      <div class="container-fluid">
          ...
          <form method="post" action="EnvoyerMessageEP" >
            <div class="card card-primary card-outline">
              ...
              <c:if test="${ !empty sessionScope.prenom && !empty sessionScope.nom }">
             <a class=""><input  type="text" size="20"  value="${ sessionScope.nom }" class="form-control" name="nom_en" ><input type="text" size="20"  value="${ sessionScope.prenom }" class="form-control" name="prenom_en" ></a>
          </c:if>
                </div>
                <div class="form-group">
                  <select name="email_Me" class="form-control select2" required="required">
                            <option value="email_Me" name="email_Me">à:</option>
                ...
                <div class="form-group">
                <label>Objet</label>
                  <a class=""><input  type="text" size="20"  value="" class="form-control" name="objet" ></a>
                  <label>Contenu</label>
                <textarea class="textarea" placeholder="Ecrire votre message..." name="contenu" id="1" onchange="alert(document.getElementById('1').value);"
              ...
              <div class="card-footer">
                ...
                <button onclick="window.location.href='listeMessageEmoplye'" class="btn btn-default"><i class="fas fa-undo-alt"></i> Retour</button>
