                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">nombre de retard</th>
                  ...
                  <c:forEach var="eme" items="${employe}">
                      ...
                      <td class="align-middle text-center text-sm">
                        <p class="text-xs font-weight-bold mb-0">${eme.id_Re}</p>
                      </td>
                      
                      
                    
                      <td class="align-middle text-center">
                        <p class="text-xs font-weight-bold mb-0">${eme.nbreR}</p>
                      </td>
                      <td class="align-middle">
                        <a href="voir1?id_Re=${eme.id_Re}" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                          voir
                        </a>
