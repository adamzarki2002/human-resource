            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="EPSE" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>EP/SE(1ere et 3eme semaine)</p>
                </a>
              </li>
             <li class="nav-item">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">modifier Absence</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          <!-- left column -->
            ...
            <div class="card card-primary" style="margin-left:255px">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form method="post" id="demo-form2"action="modifierAbsence?idA=${idA.getIdA()}"; data-parsley-validate>
              <div class="card-body">
             <!-- <div class="form-group">
                    <label for="exampleInputEmail1">Nom<span class="required">*</span></label>
                    <input type="text" class="form-control" id="exampleInputEmail1" name="nom" value="${ eme.nom}" required="required">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Prenom<span class="required">*</span></label>
                    <input type="text" class="form-control" id="exampleInputEmail1" name="prenom" value="${ eme.prenom}" required="required">
                  </div>-->
              <div class="form-group">
                    <label for="exampleInputEmail1">id<span class="required">*</span></label>
                    <input type="text" class="form-control" id="exampleInputEmail1" name="id_Ab" value="${ idA.id_Ab}" required="required">
                  </div>
                  ...
                  <input class="form-control" id="ana" name="dateA" value="${ idA.dateA}" >
                ...
                <div class="form-group">
                  ...
                  <select   class="form-control select1" name="natureA" value="${idA.natureA}" style="width: 100%;" required>
                    <option selected disabled >${idA.natureA}</option>
                ...
                <div class="item form-group">
                        <div class="col-md-8 col-sm-8 offset-md-4">
                          <a href="listeAbsence"><button class="btn btn-primary" type="button">Annuler</button></a>
