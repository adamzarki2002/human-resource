        ...
        <div class="row">
          ...
          <c:forEach var="eme" items="${employe}" begin = "0" end = "0">
           <li class="list-group-item">
                    <b>nombre de retard</b> <a class="float-right"><input type="text" size="20"  placeholder="${eme.nbreR}" class="form-control" name="nbreA" disabled="disabled" ></a>
                  </li></c:forEach>
            <!-- Profile Image -->
                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">nature de retard</th>
                  ...
                  <c:forEach var="eme" items="${employe}">
                      ...
                      <td class="align-middle text-center text-sm">
                        <p class="text-xs font-weight-bold mb-0">${eme.natureR}</p>
                      </td>
