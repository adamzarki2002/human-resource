        ...
        <div class="col-md-16" style="margin-left:90px">
          <div class="card card-primary card-outline">
            ...
            <div class="card-body">
                ...
                <thead>
                <tr>
                  <th style="width: 30%">id du message</th>
              ...
              <tbody >
                 <c:forEach var="msg" items="${employe }" >
                  
                  
                  <tr  style="list-style-type:disc;">
                  <td onclick="window.location='afficherMessage?idMe=${msg.idM}';" class="mailbox-subject"><b>${msg.idM }</b>
                    <td class="mailbox-name" onclick="window.location='afficherMessage?idMe=${msg.idM}';">${msg.email }</td>
                    <td onclick="window.location='afficherMessage?idMe=${msg.idM}';" class="mailbox-subject"><b>${msg.objet }</b>
                    </td>
                    <td onclick="window.location='afficherMessage?idMe=${msg.idM}';" ><b> <i class="fas fa-clock mr-1"> </i>${msg.dateE }</b>
                    </td>
                  </tr>
