            ...
            <div class="card-body px-0 pb-2">
              <div class="table-responsive p-0">
                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">employes</th>
                  ...
                  <c:forEach var="em" items="${employes}">
                      ...
                      <td>
                        <p class="text-xs font-weight-bold mb-0">${em.nom} ${em.prenom}</p>
                        <p class="text-xs text-secondary mb-0"></p>
                      </td>
                      <td class="align-middle text-center text-sm">
                        <p class="text-xs font-weight-bold mb-0">${em.id}</p>
                      </td>
                      ...
                      <td class="align-middle">
                        <a href="edit?id=${em.id}" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                          Edit
                        </a>
                      </td>
                      <td class="align-middle">
                        <a href="supprimerEmploye?id=${em.id}" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="supprimer user">
                          delete
                        </a>
                      </td>
