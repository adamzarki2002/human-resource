        ...
        <div class="row">
          <!-- left column -->
            ...
            <div class="card card-primary" style="margin-left:255px">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" action="<%=request.getContextPath()%>/ajouterEmploye"; method="post">
                <div class="card-body">
                <div class="form-group">
                    <label for="exampleInputEmail1">Nom Employer<span class="required">*</span></label>
                    <input type="text" class="form-control" id="exampleInputEmail1" name="nom" placeholder="Enter nom" required="required">
                  </div>
                <div class="form-group">
                    <label for="exampleInputEmail1">Prenom Employer<span class="required">*</span></label>
                    <input type="text" class="form-control" id="exampleInputEmail1" name="prenom" placeholder="Enter nom" required="required">
                  </div>  
                  <div class="form-group">
                ...
                <div class="input-group mb-3">
                    <input type="password" class="form-control" name="mdp" id="mdp" placeholder="Entez mot de passe" required="required">
                  ...
                  function myfunction(){
                    ...
                    var pswrd=document.getElementById("mdp");
                  ...
                  <div class="form-group">
                    <label for="exampleInputEmail1">Salaire<span class="required">*</span></label>
                    <input type="text" class="form-control" id="exampleInputEmail1" name="salaire" placeholder="Enter salaire" required="required">
                  </div>
                  <div class="form-group">
                  <label>Role<span class="required">*</span></label>
                  <select name="role" class="form-control select2" placeholder="definr le role" style="width: 100%;">
                    <option>employe</option>
                    <option>admin</option>
                  </select>
                </div>
                <div class="form-group">
                    <label for="exampleInputEmail1">Numero de telephone <span class="required">*</span></label>
                    <input type="text" class="form-control" id="exampleInputEmail1" name="numtel" placeholder="Enter numero de telephone" required="required">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Adresse <span class="required">*</span></label>
                    <input type="text" class="form-control" id="exampleInputEmail1" name="adresse" placeholder="Enter l'addresse" required="required">
                  </div>
